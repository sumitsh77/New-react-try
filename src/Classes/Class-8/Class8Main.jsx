...
const Class5Main = () => {
  return (
    <div className='py-20 text-center bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] from-red-900 via-violet-200 to-orange-500'>
      <h1 className='text-center text-xl  lg:text-5xl font-mono    font-bold'>PLEASE SELECT  YOUR CLASS 8  SUBJECT </h1>
      <br />
      {/* subject section-1 */}
